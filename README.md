...
**Чертежи и модели.** Просмотр DWG, DXF и файлов Inventor (детали, сборки, чертежи, презентации) прямо в панели просмотра, без запуска CAD. Колонки со свойствами: обозначение, материал, масса, версия программы, в которой сохранён файл. Фильтры по этим свойствам.
