...
namespace Files.App.Utils.Cloud
{
	...
	public sealed class SynologyDriveCloudDetector : AbstractCloudDetector
	{
		protected override async IAsyncEnumerable<ICloudProvider> GetProviders()
		{
			...
			await configFile.CopyAsync(await AppStorage.GetTemporaryFolderAsync(), "synology_drive.db", NameCollisionOption.ReplaceExisting);

			var syncDbPath = Path.Combine(AppStorage.TemporaryFolderPath, "synology_drive.db");
