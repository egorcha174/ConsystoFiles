...
namespace Files.App.Helpers
{
	...
	public sealed class LayoutPreferencesItem
	{
		...
		public LayoutPreferencesItem()
		{
			...
			ColumnsViewModel.ExtensionColumn.UserCollapsed = !UserSettingsService.LayoutSettingsService.ShowExtensionColumn;
			ColumnsViewModel.BookAuthorColumn.UserCollapsed = !UserSettingsService.LayoutSettingsService.ShowBookAuthorColumn;
			ColumnsViewModel.BookSeriesColumn.UserCollapsed = !UserSettingsService.LayoutSettingsService.ShowBookSeriesColumn;
			ColumnsViewModel.CadPartNumberColumn.UserCollapsed = !UserSettingsService.LayoutSettingsService.ShowCadPartNumberColumn;
			...
			ColumnsViewModel.ExtensionColumn.UserLengthPixels = UserSettingsService.LayoutSettingsService.ExtensionColumnWidth;
			ColumnsViewModel.BookAuthorColumn.UserLengthPixels = UserSettingsService.LayoutSettingsService.BookAuthorColumnWidth;
			ColumnsViewModel.BookSeriesColumn.UserLengthPixels = UserSettingsService.LayoutSettingsService.BookSeriesColumnWidth;
			ColumnsViewModel.CadPartNumberColumn.UserLengthPixels = UserSettingsService.LayoutSettingsService.CadPartNumberColumnWidth;
